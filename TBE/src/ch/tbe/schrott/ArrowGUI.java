...
public class ArrowGUI extends JFrame {
	...
	GraphConstants.setBounds(cells[0].getAttributes(),
		new Rectangle2D.Double(40, 40, 30, 15));
	...
	GraphConstants.setBounds(cells[1].getAttributes(),
		new Rectangle2D.Double(140, 140, 20, 20));
	...
	GraphConstants.setLineEnd(edge4.getAttributes(),
	...
	GraphConstants.setLineEnd(edge7.getAttributes(),
