...
public class TBEGraphConstants {
   ...
   */
	...
	/** Represents a double line style */
   ...
   * an Integer value indicating along which axis a cell may be moved. Constants
   ...
   * attribute contains a list of attribute-keys which should be removed at the
   * receiving views.
   */
   ...
   * Integer as values for this key. Constants defined in JLabel class. This key
   * value pair is for placment of label on vertex cell. Valid values would be
   ...
   * Key/Value pair is for placment of label on vertex cell. Valid values would
   * be JLabel.LEFT, JLabel.CENTER, JLabel.RIGHT
   */
   ...
   * of Integer as values for this key. Constants defined in JLabel class. This
   * Key/Value pair affects text postion of label on vertex cell relative to
   * image, the value is of type SwingConstant.
   */
...
public static final String ICONBOUNDS = "iconbounds";
   ...
   * as a cell and looked-up in the cell mapper to find the corresponding view.
   * If a view is found, its attributes are cloned and used as a property map,
   * along with the cell as a key.
   * <p>
   ...
   */
	...
	/**
   * Merges the specified nested maps by adding all attributes in the change to
   * the attributes for the cell in target, if the cell does not exist in
   * target, then a new entry is added with all attributes from change. Returns
   * the modified target map.
   * 
   ...
   * transport map indicating the attribute removal @ param value The attributes
   * to be removed
   */
	@SuppressWarnings("unchecked")
   ...
   * aruguments of type SwingConstants (for JLabel) i.e. JLabel.TOP etc. Default
   * value is JLabel.CENTER. This method has no effect on edge cells.
   */
	@SuppressWarnings("unchecked")
   ...
   */
	...
	/**
   * This method set the text of a label on vertext cell relative to image. See
   * JLabel api. Default value is JLabel.BOTTOM.
   */
	@SuppressWarnings("unchecked")
   ...
   */
	...
	/**
   * This method set the text of a label on vertext cell relative to image. See
   * JLabel api. Default value is JLabel.CENTER.
   */
	@SuppressWarnings("unchecked")
   ...
   */
	...
	/**
   * Returns the value attribute from the specified map. Only use for transport
   * maps, not storage map since the value is removed from the final storage map
   * 
   ...
   * This detemines whether or not a cell may be selected. Vertices and edges
   * may be selectable, not ports.
   */
	@SuppressWarnings("unchecked")
   ...
   */
	...
	/**
   * Sets the childrenselectable attribute in the specified map to the specified
   * value.
   */
	@SuppressWarnings("unchecked")
   ...
   * The two defaults points are the start and end of the edge. For example, for
   * an simple orthogonal edge there will be two extra points indicating where
   * the two right-angled bends are. This attribute can only be applied to an
   * edge.
   */
	@SuppressWarnings("unchecked")
   ...
   */
	...
	/**
   * Sets the offset attribute in the specified map to the specified value. The
   * offset is the position of a port relative to its origin, note this
