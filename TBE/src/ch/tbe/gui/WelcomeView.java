...
public class WelcomeView extends View {
	...
	try {
	    welcomeViewStream = WelcomeView.class
	...
	// WelcomeText
	JTextArea titleLabel = new JTextArea(welcomeViewLabels
		.getString("welcome")
	...
	centerPanel.setBorder(BorderFactory.createMatteBorder(20, 20, 20, 20,
		Color.WHITE));
	...
	TitledBorder recentlyTitle = BorderFactory
		.createTitledBorder(welcomeViewLabels.getString("open"));
	...
	TitledBorder newTitle = BorderFactory
		.createTitledBorder(welcomeViewLabels.getString("new"));
	...
	moreSportsLabel
		.addMouseListener(new NewListener(new Sport("Unihockey")));
